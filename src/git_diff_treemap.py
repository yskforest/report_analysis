        ...
        rows.append(
            {
                ...
                "ChangeRatio": round(change.changed_lines / total_lines, 6) if total_lines else 0.0,
            }
        )
...
def main(argv: list[str]) -> int:
    ...
    try:
        ...
        df = collect_rows(repo, args.base_ref, args.target_ref, args.worktree, extensions, excludes, progress)
        if df.empty:
